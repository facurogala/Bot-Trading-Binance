...
MAX_POSITIONS      = int(os.getenv("MAX_POSITIONS_SCALPING_LAX", os.getenv("MAX_POSITIONS", "3")))
...
SL_ATR_MULT = _float_env(1.3, "SCALPING_LAX_SL_ATR_MULT", "SCALPING_SL_ATR_MULT")
TP_ATR_MULT = _float_env(2.8, "SCALPING_LAX_TP_ATR_MULT", "SCALPING_TP_ATR_MULT")  # ATR base más amplio por defecto
...
REPORT_BASENAME = "trading_report_lax"
